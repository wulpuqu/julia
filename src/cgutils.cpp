        ...
        unsigned alignment = 0)
{
    ...
    StoreInst *store = ctx.builder.CreateAlignedStore(r, ptr, isboxed || alignment ? alignment : julia_alignment(jltype));
    if (isboxed)
        ...
        const jl_cgval_t &rhs, bool checked, bool wb)
{
    if (sty->mutabl || !checked) {
        ...
        if (jl_field_isptr(sty, idx0)) {
            ...
            cast<StoreInst>(tbaa_decorate(strct.tbaa, ctx.builder.CreateStore(r,
